...
class Tile(enum.Enum):
  ...
  SLUG_HOLE          = (12, False,  True, (0xBD, 0x20, 0x20))
  FOUNDATION         = (14, False,  True, (0xBF, 0xBF, 0xBF))
  POWER_PATH         = (24, False,  True, (0x9D, 0x9B, 0x00))
  LANDSLIDE_RUBBLE_4 = (60, False,  True, (0x18, 0x00, 0x32))
  LANDSLIDE_RUBBLE_3 = (61, False,  True, (0x18, 0x00, 0x32))
  LANDSLIDE_RUBBLE_2 = (62, False,  True, (0x18, 0x00, 0x32))
  LANDSLIDE_RUBBLE_1 = (63, False,  True, (0x18, 0x00, 0x32))
  # Wall tiles
